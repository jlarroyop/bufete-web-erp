...
import com.bufete.backend.payload.UserIdentityAvailability;
import com.bufete.backend.payload.UserSummary;
...
public class UserController {
	...
	public ResponseEntity<?> assignRoles(@Valid @RequestBody AssignRequest assignRequest) {
		...
		return ResponseEntity.ok(new ApiResponse(true, "Roles assign to User successfully"));
	}
}
